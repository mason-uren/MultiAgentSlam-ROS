...
#
# Find the distributed_slam library.
#
...
message(STATUS "CMAKE_CURRENT_SOURCE_DIR: ${CMAKE_SOURCE_DIR}/${TARGET_DIRECTORY_NAME}/src")
...
find_path(
        ...
        NAMES
            ${INCLUDE_HDRS}
        PATHS
            ${CMAKE_SOURCE_DIR}/${TARGET_DIRECTORY_NAME}/src
        PATH_SUFFIXES
...
message(
       STATUS " ${PACKAGE_TARGET_NAME}_FOUND : ${${PACKAGE_TARGET_NAME}_FOUND}
                ${PACKAGE_TARGET_NAME}_INCLUDE_DIR : ${${PACKAGE_TARGET_NAME}_INCLUDE_DIR}
                ${PACKAGE_TARGET_NAME}_VERSION : ${${PACKAGE_TARGET_NAME}_VERSION} "
)
